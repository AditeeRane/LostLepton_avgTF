...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	    if [ $type -eq 0 ]; then    
		export Output_root_file=Prediction_0_ST_${TStr}_${outStr}_${i}_00.root
	    fi
		...
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = Prediction_0_ST_${TStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_T_${TStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'Prediction_0_ST_${TStr}_${outStr}_${i}_00.root = TauHad2Multiple/Prediction_0_ST_${TStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
