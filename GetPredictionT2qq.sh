...
export SubmitFile=submitScriptT2qqSignal.jdl
...
let a=-1
i=`expr $a + 1`
for m in 300 350 400 450 500 550 600 650 700 750 800 850 900 950 1000 1050 1100 1150 1200 1250 1300 1350 1400 1450 1500 1550 1600 1650 1700 1750 1800; do

#for m in 600; do
    
#    for d in 1; do
    for d in 1 100 200 250 275 300 325 350 375 400 425 450 475 500 525 550 575 600 625 650 675 700 725 750 775 800 825 850 875 900 925 950 975 1000 1025 1050 1075 1100 1125 1150 1175 1200 1225 1250 1275 1300 1325 1350 1375 1400; do 
	...
	export filename=RA2bin_T2qq_${m}_${d}_fast 
...
#	    export skmFile=tree_T2qq_${m}_${d}_fast.root
...
#	    export btagTwoB=btag/${btagTwo}
	    ...
	    export Output=qsub/condor_T2qq_${m}_${d}.out
	    export Error=qsub/condor_T2qq_${m}_${d}.err
	    export Log=qsub/condor_T2qq_${m}_${d}.log
