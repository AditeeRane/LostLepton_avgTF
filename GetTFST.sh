...
for TStr in tW_top tW_antitop s_channel t_top t_antitop; do
...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	    if [ $type -eq 0 ]; then    
		export Output_root_file=TF_0_ST_${TStr}_${outStr}_${i}_00.root
	    fi
		...
		echo Transfer_Input_Files = MakeTF.C,TFMaker.h,TFMaker.C,SFSR_0.root,SFCR_0.root,SFSR_1.root,SFCR_1.root,SFSR_2.root,SFCR_2.root,SearchBins.h,LLTools.h,${SUBMIT_DIR}/${ArgTwoB},${SUBMIT_DIR}/SFs_ICHEP16,${SUBMIT_DIR}/SFs_Moriond17,${SUBMIT_DIR}/btag,${SUBMIT_DIR}/pu,${SUBMIT_DIR}/isr>> ${SubmitFile}
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = TF_0_ST_${TStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_T_${TStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'TF_0_ST_${TStr}_${outStr}_${i}_00.root = TauHad2Multiple/TF_0_ST_${TStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi

#		echo transfer_output_remaps = '"'MuJetMatchRate_T_${TStr}_${outStr}_${i}_00.root = TauHad2Multiple/MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
