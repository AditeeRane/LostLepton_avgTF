...
void GetPiChart2DHigherHTMHT(int hNum){
  ...
  */
  ...
  Float_t valNJet10[] = {1390.8,7662.9,12.19};
  Float_t valNJet11[] = {173.4,871.5,2.6};
  Float_t valNJet12[] = {17.5,88.6,0.3};

  Float_t valNJet20[] = {548.7,2206.4,7.189};
  Float_t valNJet21[] = {140.5,461.9,2.7};
  Float_t valNJet22[] = {48.4,84.2,1.12};

  Float_t valNJet30[] = {128.6,302.7,4.15};
  Float_t valNJet31[] = {70,100.2,1.37};
  Float_t valNJet32[] = {35.8,29.9,0.5};

  Float_t valNJet40[] = {17.5,35.4,1.53};
  Float_t valNJet41[] = {14.7,21.17,0.66};
  Float_t valNJet42[] = {20.8,8.78,0.72};
...
*/
  ...
  TLatex * textHT=new TLatex(0.75,0.35,"H_{T} > 600 GeV");
  textHT->SetTextSize(0.18);
  textHT->SetTextColor(1);
  textHT->Draw();

  TLatex * textMHT=new TLatex(0.75,0.1,"H_{T}^{miss} > 600 GeV");
...
void GetPiChart2DHigherHTMHT(){
  
  GetPiChart2DHigherHTMHT(1300);
