...
#for WJetStr in HT_1200_2500 HT_600_800 HT_800_1200 HT_2500_Inf; do
#for WJetStr in HT_2500_Inf; do
#for WJetStr in T_SingleLep Tbar_SingleLep; do
#for WJetStr in Tbar_SingleLep; do
...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	if [ $type -eq 0 ]; then    
	    export Output_root_file=SFCR_0_WJet_${WJetStr}_${outStr}_${i}_00.root
	fi
	if [ $type -eq 1 ]; then    
	    export Output_root_file=SFSR_0_WJet_${WJetStr}_${outStr}_${i}_00.root
	fi
		...
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = SFCR_0_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'SFCR_0_WJet_${WJetStr}_${outStr}_${i}_00.root = TauHad2Multiple/SFCR_0_WJet_${WJetStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
		if [ $type -eq 1 ]; then    
		    echo Transfer_Output_Files = SFSR_0_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'SFSR_0_WJet_${WJetStr}_${outStr}_${i}_00.root = TauHad2Multiple/SFSR_0_WJet_${WJetStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
