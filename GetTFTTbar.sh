...
for TTbarStr in HT_1200_2500 HT_2500_Inf; do
...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	    if [ $type -eq 0 ]; then    
		export Output_root_file=TF_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root
	    fi
		...
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = TF_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'TF_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/TF_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
