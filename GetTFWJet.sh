...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	    if [ $type -eq 0 ]; then    
		export Output_root_file=TF_0_WJet_${WJetStr}_${outStr}_${i}_00.root
	    fi
		...
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = TF_0_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_WJet_${WJetStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'TF_0_WJet_${WJetStr}_${outStr}_${i}_00.root = TauHad2Multiple/TF_0_WJet_${WJetStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
