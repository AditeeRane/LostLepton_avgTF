...
void WrapUpT1ttttSearchBinHist(string type="T1bbbb",string outStr="Jul"){

  char tempname[200];
  char filenames[500];
  char histName[200];
  // open a file to write the output 
  sprintf(tempname,"%s_GetSearchBinHist.root",type.c_str());
  ...
  // *AR 180622:Output files in TauHad2Multiple are already scaled to 1/pb, as scaleFactorweight is not applied for signal in Prediction code.
    double ScaleLumiTo     = 35900; //(pb-1)
  double ScaleLumiFrom = 1; // normaliza to 3 (fb-1)
  ...
  TDirectory * tdirSearch = outfile->mkdir("SearchReg");
...
// *AR -Jul22,2016-With Rishi's request to be consistent with Simon's naming
    ...
    //    sprintf(filenames,"TauHad2Multiple/HadTauEstimation_%s-Apr22_00.root",filesVec.at(in).c_str());  
    sprintf(filenames,"TauHad2Multiple/Prediction_0_RA2bin_%s_%s_fast_%s_00.root",type.c_str(),filesVec.at(in).c_str(),outStr.c_str());
    ...
    temphist = (TH1D*) infile->Get("h_SearchStat")->Clone();
    ...
    sprintf(tempname,"%s_%s_%s","h_HT_SearchStat",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_HT_SearchStat")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_MHT_SearchStat",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_MHT_SearchStat")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_NJet_SearchStat",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_NJet_SearchStat")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_NBTag_SearchStat",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_NBTag_SearchStat")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_HTBins",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_HTBins")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_MHTBins",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_MHTBins")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_NJetBins",elems.at(0).c_str(),elems.at(1).c_str());
    temphist = (TH1D*) infile->Get("h_NJetBins")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
    ...
    sprintf(tempname,"%s_%s_%s","h_NBTagBins",elems.at(0).c_str(),elems.at(1).c_str());

    temphist = (TH1D*) infile->Get("h_NBTagBins")->Clone();
    temphist->Scale(ScaleLumiTo/ScaleLumiFrom);
    temphist->SetName(tempname);
    temphist->SetTitle(tempname);
    tdirSearch->cd();
