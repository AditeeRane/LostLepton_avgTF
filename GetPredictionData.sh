...
#	    export ArgOne=MakeSFs.C    
		...
		echo Transfer_Input_Files = 2017BCDE.json,2017F.json,Prediction.h,Prediction.C,MakePrediction_Data.C,TF.root,SearchBins.h,LLTools.h,${SUBMIT_DIR}/${ArgTwoB},${SUBMIT_DIR}/SFs_ICHEP16,${SUBMIT_DIR}/SFs_Moriond17,${SUBMIT_DIR}/btag,${SUBMIT_DIR}/pu,${SUBMIT_DIR}/isr>> ${SubmitFile}
