...
void GetOneDPlotsMCVsMC(char const * Var,char const * Sample,char const * TTbarLL, char const * TTbarHadtau,char const *xRatioLabel,char const *yRatioLabel,int RatioNbins,double RatioXmin,double RatioXmax,double topMax){
