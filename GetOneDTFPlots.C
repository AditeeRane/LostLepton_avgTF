...
void GetOneDTFPlots(int hNum,char const * VarCS, char const * VarPre, char const * VarPreLL, char const * VarPreHadtau,char const * Sample,char const * TTbarLL,char const * WJetLL,char const * LegHeader,double Legxmin,double Legymin,double Legxmax,double Legymax,char const *xRatioLabel,char const *yRatioLabel,bool logy, bool logx,int RatioNbins,double RatioXmin,double RatioXmax,double RatioYmin,double RatioYmax,double topMax){
...
*/
  ...
  hWJetPreHadtau->SetLabelSize(0.032);
  hWJetPreHadtau->SetLabelFont(42);
  hWJetPreHadtau->SetLabelSize(0.215,"XY");
  ...
  tl->SetNColumns(2);
  tl->AddEntry(hTTbarPreHadtau," t#bar{t}(SR):#tau_{h}");
  tl->AddEntry(hWJetPreHadtau,"W+jets(SR):#tau_{h}");

  tl->AddEntry(hTTbarPreLL," t#bar{t}(SR):LL");
  tl->AddEntry(hWJetPreLL,"W+jets(SR):LL");

  tl->AddEntry(hTTbarCS," t#bar{t}(CR):1L");
...
*/
  ...
  GetOneDTFPlots(1300,"h_CSStat_NJetvsNBtag_1D","h_Prediction_NJetvsNBtag_1D","h_PredictionLL_NJetvsNBtag_1D","h_PredictionHadtau_NJetvsNBtag_1D","2017_TF","Prediction_0_haddTTbar_0L_.root","Prediction_0_haddWJet_0L_.root","SR+CR",0.57,0.55,0.88,0.77,"bin index","Transfer Factor",1,0,19,1,20,0,2.49,200000);
