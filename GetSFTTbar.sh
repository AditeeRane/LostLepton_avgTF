...
#for TTbarStr in DiLept T_SingleLep Tbar_SingleLep ; do
...
#	    export ArgOne=MakeSFs.C    
	    ...
	    #echo $Proxy
	if [ $type -eq 0 ]; then    
	    export Output_root_file=SFCR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root
	fi
	if [ $type -eq 1 ]; then    
	    export Output_root_file=SFSR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root
	fi
...
#		    echo x509userproxy = ${Proxy}>> ${SubmitFile}
		...
		if [ $type -eq 0 ]; then    
		    echo Transfer_Output_Files = SFCR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'SFCR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/SFCR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
		if [ $type -eq 1 ]; then    
		    echo Transfer_Output_Files = SFSR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		    echo transfer_output_remaps = '"'SFSR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/SFSR_0_TTbar_${TTbarStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
		fi
